...
- [2.0.7. Show me by example how to use distcp across Azure regions](DisasterRecovery.md#207--show-me-step-by-step-how-distcp-is-done-on-azure-across-datacenters)
<hr>
...
2. Ensure there are no overlapping IP addresses across clusters/datacenters
